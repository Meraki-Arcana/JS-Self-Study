/*
    1. Create an array called "items" with this following values:
        ...
        4. Add all the Objects in "items" to "results" om prder, while skipping over any duplicate-objects you encounter within "items" (In this example, only add the first banana item)
