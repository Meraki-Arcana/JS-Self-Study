/*
    ...
    4. If it is equal to "cat", print out "Meow!" to the console.
    5. If it is equal to "dog" print out "Woof!" to the console.
    6. If it is neither "cat" nor "dog", print out "Must be an alien 👽"
    7. At the end o the program print out "---Animal check complete---"
...
//Changing the value from cat or dog will result in "Must be an alien". Test it out :)